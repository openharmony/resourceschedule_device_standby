...
private:
    ...
    uint32_t FilterOutUnpermittedResType(uint32_t resourceNumber, const int32_t uid,
        const std::string &bundleName);
    std::set<int32_t> QueryRunningResourcesApply(const int32_t uid, const std::string& bundleName);
